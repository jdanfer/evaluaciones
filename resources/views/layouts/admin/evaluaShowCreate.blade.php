        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Evaluación A: {{ $lapersona->persona_nom1}} {{$lapersona->persona_ape1}}</h3>
            </div>
          </div>
        </div>
      </div>
...
<!--                <a class="nav-link" href="#" data-toggle="modal" data-target="#contacto-modal">Contacto</a> -->
                      ...
                      @foreach($autoevaluas as $autoevalua)
                          <tr>
                              ...
                              <td style="width: 100px;">
                                <a class="btn btn-sm btn-primary" role="button" data-toggle="modal" data-target="#modal-edit-{{ $autoevalua->id }}">Editar</a>
                                  <div class="modal fade" id="modal-edit-{{ $autoevalua->id }}" tabIndex="-1">
                                    <div class="modal-dialog" role="document">
                                       <form action="{{ url('admin/evaluaciones/' . $autoevalua->id . '/editar') }}" method="post" >
                                        @csrf
                                          <div class="modal-content">
                                            <div class="modal-header text-center">
                                                <h4 class="modal-title w-100 font-weight-bold">Puntaje de pregunta Nro: {{$autoevalua->pregunta->pregunta_nro}}</h4>
                                            ...
                                            <div class="modal-body mx-3">
                                              <div class="md-form mb-5">
                                                  ...
                                                  <input type="number" min="1" max="4" style="width: 200px;" id="puntos" class="form-control validate" name="puntos" value="{{ old('puntos', $autoevalua->puntos) }}">
                                               </div>
                                            </div>
                                            <div class="modal-body mx-3">
                                              <div class="md-form mb-5">
                                            ...
                                            <input style="visibility: hidden" type="text" id="titulo_id" name="titulo_id" value="{{ old('titulo_id', $autoevalua->titulo_id) }}">
                                            <input style="visibility: hidden" type="text" id="periodo" name="periodo" value="{{ old('periodo', $autoevalua->periodo) }}">
    ...
    <div class="row" style="padding: 10px">
      <div class="col-lg-2 col-md-8">
        <div class="card">
          <a href="/admin/evaluaciones" class="btn btn-danger btn-lg active" role="button" aria-pressed="true">Ir a Personas</a>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-md-8">
        <div class="card">
          <a class="btn btn-warning btn-lg active" href="{{ url('admin/evaluacion/' . $lapersona->id . '/cerrar') }}" 
