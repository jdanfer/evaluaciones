                  ...
                  @foreach($personas as $persona)
                      <tr>
                          ...
                          <td style="width: 100px;">
                              <a href="{{ url('admin/personas/' . $persona->id . '/editar') }}" class="btn btn-sm btn-primary">Editar</a>
                          </td>
                          <td style="width: 100px;">
                            <a class="btn btn-sm btn-danger" href="{{ url('admin/personas/' . $persona->id . '/eliminar') }}" 
