            ...
            <form id="editaUser" method="post" action="{{ route('profile.update') }}" autocomplete="off">
              ...
              <div class="card-body">
                ...
                <div class="input-group mb-3">
                  <input type="text" style="width: 300px;" class="form-control" id="documento" name="documento" placeholder="Cédula indentidad..." required value="{{ old('documento', auth()->user()->documento) }}">
                ...
                <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                  ...
                  <input type="email" name="email" id="input-email" class="form-control form-control-alternative{{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="{{ __('Correo electrónico') }}" value="{{ old('email', auth()->user()->email) }}" required autofocus>
                  @if ($errors->has('email'))
                      <span class="invalid-feedback" role="alert">
