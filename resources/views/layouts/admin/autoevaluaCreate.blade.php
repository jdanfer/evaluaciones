...
<!--                <a class="nav-link" href="#" data-toggle="modal" data-target="#contacto-modal">Contacto</a> -->
                                  ...
                                  <a class="btn btn-sm btn-primary" role="button" data-toggle="modal" data-target="#modal-edit-{{ $autoevalua->id }}">Editar</a>
                                    <div class="modal fade" id="modal-edit-{{ $autoevalua->id }}" tabIndex="-1">
                                      <div class="modal-dialog" role="document">
                                        <form action="{{ url('admin/autoevaluaciones/' . $autoevalua->id . '/editar') }}" method="post" >
                                          @csrf
    ...
    <div class="row" style="padding: 10px">
      ...
      <div class="col-lg-3 col-md-8">
        <div class="card">
          <a class="btn btn-warning btn-lg active" href="{{ url('admin/autoevaluacion/' . auth()->user()->documento . '/cerrar') }}" 
            onclick="return confirm('¿Seguro que deseas cerrar tu Autoevaluación?')">
            <span aria-hidden="true" class="glyphicon glyphicon-trash">
            </span>
            Cerrar Autoevaluación</a>
        </div>
