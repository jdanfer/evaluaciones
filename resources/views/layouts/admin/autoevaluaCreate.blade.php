    ...
    <div class="header bg-gradient-default pb-8 pt-5 pt-md-8">
                                                    ...
                                                    @else
                                                        ...
                                                        <div class="modal fade" id="modal-edit-{{ $autoevalua->id }}"
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                <form
                                                                    action="{{ url('admin/autoevaluaciones/' . $autoevalua->id . '/editar') }}"
                                                                    method="post">
                                                                    @csrf
                                                                    <div class="modal-content">
                                                                        <div class="modal-header text-center">
                                                                            <h4 class="modal-title w-100 font-weight-bold">
                                                                                ...
                                                                                {{ $autoevalua->pregunta->pregunta_nro }}
                                                                            </h4>
        ...
        <div class="row" style="padding: 10px">
            <div class="col-lg-2 col-md-8">
                <div class="card">
                    <a href="/home" class="btn btn-danger btn-lg active" role="button" aria-pressed="true">Ir al
                        inicio</a>
                </div>
            </div>
